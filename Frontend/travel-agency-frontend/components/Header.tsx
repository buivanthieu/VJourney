  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md shadow-xs"> 
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8"> 
        ...
        {/* Nút bấm chuyển hướng sang trang Login */}
        <div className="flex items-center gap-4"> 
          <Link 
            href="/login"
            className="text-xs font-semibold text-slate-600 hover:text-slate-900 border border-slate-200 px-4 py-1.5 rounded-full bg-slate-50 transition-all active:scale-95"
          >
            🔑 Đăng nhập
          </Link>
